...
import { discordChannelOverwritesTopic } from "../../../data-rights/streams/topics/discord-channel-overwrites-topic.js";
...
router.get("/:guildId/stream", requireSiteAccount, validateGuildId, (req: Request, res: Response) => {
    ...
    const handle = subscribeProjection(
        `discord_channel_overwrites:${server.clan_id}:${guildId}`,
        discordChannelOverwritesTopic(server.clan_id, guildId),
