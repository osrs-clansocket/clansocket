...
const CLANSOCKET_PERMISSION = "discord:server-emojis.delete";

interface DeleteServerEmojiBody {
    userId: string;
    targetName: string;
}
...
router.delete(
    ...
    handleAsync(async (req: Request, res: Response) => {
        ...
        const body = req.body as DeleteServerEmojiBody;
        ...
        try {
            ...
            recordClanAudit(server.clan_id, {
                actor: body.userId,
                action: ClanAuditActions.DiscordServerEmojisDelete,
                targetId: emojiId,
                guildId,
                payload: {
                    guildId,
