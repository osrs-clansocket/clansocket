...
import { discordServerEmojisTopic } from "../../../data-rights/streams/topics/discord-server-emojis-topic.js";
...
router.get("/:guildId/stream", requireSiteAccount, validateGuildId, (req: Request, res: Response) => {
    ...
    const handle = subscribeProjection(
        `discord_server_emojis:${server.clan_id}:${guildId}`,
        discordServerEmojisTopic(server.clan_id, guildId),
