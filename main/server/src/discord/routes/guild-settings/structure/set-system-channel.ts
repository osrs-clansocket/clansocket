...
router.patch(
    ...
    handleAsync(async (req: Request, res: Response) => {
        ...
        try {
            ...
            const beforeJson = JSON.stringify({ subject: SUBJECT_SYSTEM_CHANNEL, channelId: body.beforeChannelId });
            ...
            logger.error(
                `[discord] guild-settings set-system-channel failed for ${guildId}: ${(err as Error).message}`,
            );
