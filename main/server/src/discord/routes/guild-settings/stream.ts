...
import { discordGuildSettingsTopic } from "../../../data-rights/streams/topics/discord-guild-settings-topic.js";
...
router.get("/:guildId/stream", requireSiteAccount, validateGuildId, (req: Request, res: Response) => {
    ...
    const handle = subscribeProjection(
        `discord_guild_settings:${server.clan_id}:${guildId}`,
        discordGuildSettingsTopic(server.clan_id, guildId),
